...
const kernel_src = [_][]const u8{
    ...
    "src/kernel/start.c", // Early machine-mode boot code.
    "src/kernel/console.c", // Connect to the user keyboard and screen.
    "src/kernel/printf.c", // Formatted output to the console.
    ...
    "src/kernel/main.c", // Control initialization of other modules during boot.
